...
以下 8 张为 Panel 168 基于不同源图独立生成的单轮样张，采用简短英文文案。横版为 1536×864、左右各 50%；竖版为 1152×1536、上下各 50%。

已观察到的偏差：部分主体与色场偏大，纸面留白不足；部分结果更接近整景转绘，留纸白负形与局部越界不够明确。保留实际结果供观察，不代表全部通过风格验收。
