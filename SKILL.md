---
name: xxd-panel-168
description: "Create Panel 168 raster artwork: Reserved-white Layered Painted Field. Use when the user invokes xxd-panel-168 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-168/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-168-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
